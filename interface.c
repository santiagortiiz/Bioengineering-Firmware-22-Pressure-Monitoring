...
void MenuLCD(uint8 menu_index){
    switch(menu_index){
        case SHOW_PREASSURE:
            ...
            LCD_Position(1,0);
            LCD_PrintU32Number(pressure/1000);       // Temperature display routine by digits
            LCD_PutChar('.');
            LCD_PrintU32Number(pressure/100%10);
            LCD_PrintU32Number(pressure/10%10);
            LCD_PrintU32Number(pressure%10);
            LCD_PrintString("kPa");
            break;
        ...
        case SHOW_TEMPERATURE:
            ...
            LCD_Position(3,0);
            LCD_PrintNumber(temperature/1000);       // Temperature display routine by digits
            LCD_PutChar('.');
            LCD_PrintNumber(temperature/100%10);
            LCD_PrintNumber(temperature/10%10);
            LCD_PrintNumber(temperature%10);
...
void MenuUART(uint8 menu_index){
    switch(menu_index){
        ...
        case SEND_DATE:
            ...
            break;
        case SEND_PREASSURE:  
            UART_PutChar(pressure/1000);
            UART_PutChar(pressure/100%10);
            UART_PutChar(pressure/10%10);
            UART_PutChar(pressure%10);
            break;
