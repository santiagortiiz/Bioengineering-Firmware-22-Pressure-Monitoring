...
void MCP7940_TimeUpdate(uint8 seconds, uint8 minutes, uint8 format_24_12, uint8 am_pm, uint8 hour, uint8 weekday, uint8 date, uint8 month, uint8 leap_year, uint8 year){
    MCP7940_Stop();
